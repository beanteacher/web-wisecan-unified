...
## 참조
- 리뷰 스킬: `.claude/skills/code-reviews/SKILL.md`
...
`.claude/skills/code-reviews/SKILL.md`의 체크리스트에 따라 검토 수행

### 5단계: 리뷰 결과 작성

리뷰 템플릿(`.claude/skills/code-reviews/SKILL.md`의 템플릿)에 따라 작성
...
**금지 사항**: PR 승인(`--approve`)은 반드시 사용자 확인 후 진행