...
flowchart LR
  ...
  REV_GRP --> R_KEY["/admin/keys/review<br>키 발급·전환"]
...
| PG-AD-010 | `/admin/keys/review` 키 발급·전환 큐 | `ADMIN` | `04 §10.10` |
...
> 페이지 총계 — 공개 10 / 회원 콘솔 23 / 어드민 16 = **49개**. 체험은 회원 콘솔 트리 재사용으로 별도 카운트하지 않음.
